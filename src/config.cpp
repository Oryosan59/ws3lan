...
AppConfig::AppConfig() :
    pwm_min(1100), pwm_neutral(1500), pwm_normal_max(1500), pwm_boost_max(1900), pwm_frequency(50.0f),
    ...
    kp_roll(0.2f), kp_yaw(0.15f), yaw_threshold_dps(1.0f), yaw_gain(1000.0f),
